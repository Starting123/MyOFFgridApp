...
class NearbyDevicesScreenFixed extends ConsumerStatefulWidget {
  const NearbyDevicesScreenFixed({Key? key}) : super(key: key);

  @override
  ConsumerState<NearbyDevicesScreenFixed> createState() => _NearbyDevicesScreenState();
}

class _NearbyDevicesScreenState extends ConsumerState<NearbyDevicesScreenFixed> {
